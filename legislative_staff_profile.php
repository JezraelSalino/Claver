...
<div class="modal fade" id="addModal" aria-hidden="true" data-bs-backdrop="static" aria-labelledby="addModalLabel" tabindex="-1">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
    <form action="includes/staff_insert.inc.php" method="post">
      <div class="modal-header">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row p-3">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3 p-2">
                            ...
                            <input type="date" name="date_employed" id="date_employed" class="form-control">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-3 p-2">
                            <label >DATE ENDED</label>
      ...
      <div class="modal-footer">
      <button type="submit" name="submit" class="btn btn-primary">Submit Staff</button>
