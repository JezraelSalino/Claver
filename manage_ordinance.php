...
<div class="header">
<h6>Manage Legislative Files / Manage Ordinance</h6>
<button type="button" class="btn btn-primary" data-bs-toggle="modal" href="#addModal">Add Ordinance</button>
</div>
...
<div class="feed">
    <div class="row p-3">
        <div class="col">
            ...
            <div class="mb-2">
                <label class="form-label">DATE ENACTED</label>
                <input type="text" class="form-control">
            </div>
            <div class="mb-2">
  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Add Ordinance</h5>
        ...
        <div class="container-fluid">
            <div class="row p-3">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <div class="mb-2">
                        <label class="form-label">ORDINANCE PDF FILE</label>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#mainModal" data-bs-toggle="modal" data-bs-dismiss="modal">Save and Sync Ordinance</button>
...
<div class="modal fade" id="updateModal" aria-hidden="true" data-bs-backdrop="static" aria-labelledby="updateModalLabel" tabindex="-1">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateModalLabel">Update Ordinance</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
